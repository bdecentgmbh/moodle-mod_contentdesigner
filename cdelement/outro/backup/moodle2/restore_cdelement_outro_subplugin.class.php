...
/**
 * This file contains the restore code for the cdelement_outro plugin.
 *
...
class restore_cdelement_outro_subplugin extends restore_subplugin {
    ...
    protected function define_contentdesigner_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/cdelement_outro');
     ...
     * @param array $data
     */
    public function process_cdelement_outro_instance($data) {
        global $DB;
        ...
        $newinstance = $DB->insert_record('cdelement_outro', $data);
        $this->set_mapping('outro_instanceid', $oldinstance, $newinstance, true);

        $this->add_related_files('mod_contentdesigner', 'cdelement_outro_outroimage', 'outro_instanceid', null, $oldinstance);
    ...
    public function after_execute_contentdesigner() {
        $this->add_related_files('mod_contentdesigner', 'cdelement_outro_outrocontent', 'outro_instanceid');
    }
}
