...
/**
 * This file contains the restore code for the element_richtext plugin.
 *
 ...
 *
 * Provides the necessary information needed to restore element_richtext.
 */
class restore_element_richtext_subplugin extends restore_subplugin {
    ...
    protected function define_contentdesigner_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/element_richtext');
    ...
    /**
     * Processes one element_richtext element
     * @param array $data
     */
    public function process_element_richtext_instance($data) {
        global $DB;
        ...
        $newinstance = $DB->insert_record('element_richtext', $data);
    ...
    public function after_execute_contentdesigner() {
        $this->add_related_files('mod_contentdesigner', 'element_richtext_content', 'richtext_instanceid');
    }
}
